...
export type GetStudentsQuery = { __typename?: 'Query', students: Array<{ __typename?: 'Student', id: string, lrn: string, firstName: string, middleName?: string | null, lastName: string, email: string, contactNo: string }> };
